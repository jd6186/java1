...
public class Input04_Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("여러 단어의 정수를 입력하세요 : ");
		String in1 = sc.next();
		...
		// nextLine을 제외한 나머지들 " nextInt(), nextDouble()... " 은 다 토큰단위로 작업됨
		// 즉, 밑에처럼 작업할 수 있어
		System.out.println("숫자 3개 입력 int double int 순 입력 : ");
		String in2 = sc.next();
		System.out.println("int타입 in2 : " + in2);
		double in3 = sc.nextDouble();
		System.out.println("double타입 in2 : " + in3);
		in2 = sc.next();
		System.out.println("int타입 in2 : " + in2);
