 ...
 *    
 *  ● format specifier (서식 지정자)    >>>>>   String.format(서식지정자가 들어간 문자열, 서식지정자로 출력할 숫자or문자) 이런식으로 활용된다.
 *  	%d  :  십진수 정수로 출력
 *  	%f  :  실수 출력
 *  	%s  :  문자열 출력
 *  	%c  :  '문자하나' 출력
...
public class PrintfMain {
	public static void main(String[] args) {
		...
		System.out.println("513은 16진수로 %x \n" + String.format("%x", 513));
		//이렇게 작성하면 %x라고만 뜨고 아무것도 안 뜬다. 즉, 반드시 따로 스트링포멧의 변수가 할당되어져야한다.
